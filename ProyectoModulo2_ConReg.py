# -*- coding: utf-8 -*-
"""
Created on Mon Sep 11 19:51:34 2023
...
plt.plot(train_sizes, train_scores_mean, 'o-', color="m", label="Puntaje de Entrenamiento")
plt.plot(train_sizes, test_scores_mean, 'o-', color="y", label="Puntaje de Validación")
