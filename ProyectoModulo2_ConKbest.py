# -*- coding: utf-8 -*-
"""
Created on Mon Sep 11 21:23:09 2023
...
# Realizar selección de características (SelectKBest)
selector = SelectKBest(f_classif, k=10)  # Se seleccionan 10 características, ajusta según lo necesites
...
plt.plot(train_sizes, test_scores_mean, 'o-', color="r", label="Puntaje de Validación")
